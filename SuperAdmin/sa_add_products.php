...
if(isset($_POST['additems'])){
    ...
    move_uploaded_file($filetmpname,$folder.$filename);
        ...
        mysqli_query($conn,"insert into products (product_name,product_price,product_discription,product_image) VALUES ('$product_name','$price','$description','$filename')") or die ('query failed'. mysqli_error($conn));
